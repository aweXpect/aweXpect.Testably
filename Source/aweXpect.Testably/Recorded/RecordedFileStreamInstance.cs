...
public sealed class RecordedFileStreamInstance
{
	...
	public RecordedMethodCallResult CopyTo(
		...
		[CallerArgumentExpression(nameof(destination))] string? destinationExpression = null,
	...
	public RecordedMethodCallResult Flush(
		...
		[CallerArgumentExpression(nameof(flushToDisk))] string? flushToDiskExpression = null)
	...
	public RecordedMethodCallResult FlushAsync(
		...
		[CallerArgumentExpression(nameof(cancellationToken))] string? cancellationTokenExpression = null)
	...
	public RecordedMethodCallResult Read(
		...
		[CallerArgumentExpression(nameof(buffer))] string? bufferExpression = null,
		[CallerArgumentExpression(nameof(offset))] string? offsetExpression = null,
	...
	public RecordedMethodCallResult Seek(
		...
		[CallerArgumentExpression(nameof(offset))] string? offsetExpression = null,
		[CallerArgumentExpression(nameof(origin))] string? originExpression = null)
